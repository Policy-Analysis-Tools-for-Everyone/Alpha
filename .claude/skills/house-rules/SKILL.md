...
The full specification is `reference/writing/anti-ai-writing-style.md`. Read it
when drafting substantial prose. This is the part that applies to every turn.
